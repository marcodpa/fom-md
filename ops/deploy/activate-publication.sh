...
release=/var/www/fom-web/releases/20260921-redesign-v1
backup=/var/backups/fom-web/20260921-redesign-v1-$(date +%Y%m%dT%H%M%S)-$$
expected=93bcf094733c8dee9bc20fae0b51302631c25b2bf4492ec54f892b74192ce1c5
