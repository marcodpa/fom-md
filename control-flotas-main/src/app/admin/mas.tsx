...
import { esMultiempresa, useAuth, useSignOut } from '@/auth';
...
/**
 * MÁS de la administración FOM: las herramientas transversales del sistema
 * (auditoría, reportes multi-empresa, comparativas) y la sesión. Cerrar sesión
 * vive SOLO aquí.
 */
export default function AdminMasSistemaScreen() {
  ...
  const secciones: Seccion[] = [
    {
      titulo: 'Mi cuenta',
      items: [
        { label: 'Mi perfil', hint: 'Tu foto, cédula, documentos y contraseña', icon: 'personal', onPress: () => router.navigate('/mi-perfil') },
      ],
    },
    {
      titulo: 'Sistema',
        ...
        <ScrollView contentContainerStyle={[styles.content, { padding: spacing.lg, gap: spacing.xl }]}>
          ...
          <Card style={{ gap: spacing.xs }}>
            ...
            <ThemedText variant="caption" color="textMuted">
              {`${user.email} · Administrador del sistema`}
            </ThemedText>
          </Card>
